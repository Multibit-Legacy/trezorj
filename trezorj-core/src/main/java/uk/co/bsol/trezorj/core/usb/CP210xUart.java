 ...
 * <ul>
 * <li>Low level read/write operations with a CP210x UART to USB bridge device</li>
 * <li>Simple stream-based communication via a {@link com.codeminders.hidapi.HIDDevice}</li>
 * </ul>
 * <p>The device </p>
 */
public class CP210xUart {

  /**
   * Provides logging for this class
   */
  private static final Logger log = LoggerFactory.getLogger(CP210xUart.class);
   ...
   */
  public CP210xUart(HIDDevice device) throws IOException {
    this.device = device;
   ...
   * @throws IOException If something goes wrong
   */
  public int purge(byte purgeType) throws IOException {
